...
data_tbl_rct <- 
    ...
    summarise(n = n()) %>%
    mutate(n_lbl = paste0(n, " (", round(n/n_papers_rct*100,1), "%)"))
...
data_tbl_pilotrct <- 
    ...
    group_by(val_type, val_edrct) %>%
    summarise(n = n()) %>%
    mutate(n_lbl = paste0(n, " (", round(n/n_papers_pilot*100,1), "%)"))
...
data_tbl_assesstype %>%
    ...
    knitr::kable(format="html", escape = T, booktabs = TRUE,    
          caption = "Distribution of assessment type.") %>%
