...
_FIXME_: One paper (id=430) is marked as "NO ASSESSMENT" and "RCT". Check it out! 
...
_NOTE_: In respond to the comment **F.2** 'Breakdown of treatment modalities' to show psychological framework per study/app. Only studies with app names are included (137). So, 21 are excluded. 
_FIXME_: Do we include studies without app name (21)?
