...
### Table 1: Evolution of assessment types 


```{r tab1new, echo=FALSE}
...
data_tbl_assesstype$val_type <- forcats::fct_relevel(data_tbl_assesstype$val_type, assessemnt_type) 
...
cowplot::ggsave(plot = plot_dist_md, filename = plot_dist_md_file_name, device = "png", path = here::here("figs"),
