...
This document is versioned in a public [git](https://git-scm.com/) repo: [https://github.com/cgranell/apps-treatment-mental-disorders](https://github.com/cgranell/apps-treatment-mental-disorders). This R notebook, `analysis.Rmd`, contains the code to produce the final figures and tables of the following [pre-print paper](https://preprints.jmir.org/preprint/14897). 
